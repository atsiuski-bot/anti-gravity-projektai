                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-2 py-3 align-top">
                                        ...
                                        {(task.tag || task.isSystemTask || task.isQuickWork || deadline || links.length > 0 || hasImage || checklist || commentCount > 0 || (showManagerLine && (task.managerName || task.creatorName))) && (
