    ...
    return (
        ...
        >
            ...
            <div className="flex-1 space-y-4 overflow-y-auto px-6 py-5">
                ...
                <div className="flex items-center gap-2 rounded-control bg-feedback-danger-soft px-3 py-2 text-body font-semibold text-feedback-danger-text">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {photos.map((p, idx) => (
                                    <div key={p.url} className="relative h-16 w-16 overflow-hidden rounded-control border border-line bg-surface-sunken">
                                        ...
                                        <img src={p.url} alt={`Priedas ${idx + 1}`} className="h-full w-full object-contain" loading="lazy" decoding="async" />
