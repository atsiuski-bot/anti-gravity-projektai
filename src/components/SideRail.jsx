...
const navItemBase =
    'flex min-h-touch items-center rounded-control text-body font-medium transition duration-base active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-ring focus-visible:ring-inset';
