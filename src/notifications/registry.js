...
export const NOTIFICATIONS = {
    ...
    session_correction_request: {
        ...
        copy: (n) => ({
            ...
            body: n.commentText ? `${n.day || 'Darbo laikas'}: ${clamp(n.commentText)}` : (n.day || 'Darbo laikas'),
        }),
    },
    ...
    session_edited: {
        ...
        push: true,
        link: TAB_TASKS,
        copy: (n) => ({ title: 'Pakoreguotas darbo laikas', body: n.day || 'Darbo laikas' }),
    },
    session_deleted: {
        category: 'info',
        sound: 'info',
        push: true,
        link: TAB_TASKS,
        copy: (n) => ({ title: 'Pašalintas darbo laikas', body: n.day || 'Darbo laikas' }),
    },
