...
const { collectReferentialTaskIds, findOrphanSessions, classifySuspiciousWorkDays, findImpossibleSpanSessions, classifyEngineAdoption, claimedTaskRun, classifySessionDisagreements } = require('./integrityScans');
